...
import LPMigration from '../../build/LPMigration.json'
...
export async function v2Fixture(provider: Web3Provider, [wallet]: Wallet[]): Promise<V2Fixture> {
  ...
  console.log("Router 1 address:",router01.address);
  console.log("Router 2 address:",router02.address);

  const lPMigration = await deployContract(wallet, LPMigration);
